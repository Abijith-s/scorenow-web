...
import { webBannerImageUpload } from "../../../apiManager/services/adminServices";
import { useSnackbar } from "notistack";

export const BannerEditWeb = () => {
  ...
  const handleSubmit = (e)=>{
    ...
    .then((result)=>{
      ...
      dispatch(webBannerImageUpload({bannerImage:result}));
    });
  };
  ...
  return (
    ...
    >
      <div className="container contact col-sm-12">
        <h1 style={{ textAlign: "center" }}>Banner Edit for Web Page</h1>
      </div>
      <div
